<?php
	...
	if (isset($_GET['modifier'])) 
	{
		...
		$request="SELECT * from agents where id='".$_GET['modifier']."' ";
    ...
    $page_title='Ajouter agent';
?>
<?php require 'header.php' ; ?>

	<form name="ajoutAgent" method="post" action="agents.php">
		<div class="container margin">
            <div class="col-sm-12">
            	<div>
                	<h3>Les informations de l'agent :</h3>
                </div>
                <div class="row">
                    <div class="col-sm-2">
                    </div>
